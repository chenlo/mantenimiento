...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'create_usuario_id'); ?>
		<?php echo $form->textField($model,'create_usuario_id'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'update_usuario_id'); ?>
		<?php echo $form->textField($model,'update_usuario_id'); ?>
	</div>
