 ...
 */
return array (
  'A role is group of permissions to perform a variety of tasks and operations, for example the authenticated user.' => 'Un rol está formado por un conjunto de permisos que permite ejecutar varias tareas y operaciones. Un ejemplo de rol es el usuario que se ha autenticado',
  'A task is a permission to perform multiple operations, for example accessing a group of controller action.' => 'Una tarea define una lista de permisos para ejecutar múltiples operaciones. Por ejemplo, agrupar todas las operaciones de gestión de incidencias en una única tareas llamada "Administar Incidencias"',
  'An operation is a permission to perform a single operation, for example accessing a certain controller action.' => 'Una operación define un permiso para ejecutar una única operación, por ejemplo, acceder a un controlador específico.',
  'Tasks exist below roles in the authorization hierarchy and can therefore only inherit from other tasks and/or operations.' => 'Las tareas sólamente heredan de otras tareas y/o operaciones',
  'Authorization items can be managed under {roleLink}, {taskLink} and {operationLink}.' => 'Los items de autorización se administran con  {roleLink}, {taskLink} y {operationLink}.',
  'Cancel' => 'Cancelar',
  'Generate items' => 'Generar items',
  'Generate items for controller actions' => 'Generar los items de los controladores',
  'Here you can view and manage the permissions assigned to each role.' => 'Aquí puedes ver y administrar los permisos asignados a cada rol.',
  'Operations exist below tasks in the authorization hierarchy and can therefore only inherit from other operations.' => 'En la jerarquía de permisos, las operaciones están por debajo de las tareas, por lo que sólo pueden heredar de otras operaciones.',
  'Permission :name assigned.' => '',
  'Permission :name revoked.' => '',
  'Roles exist at the top of the authorization hierarchy and can therefore inherit from other roles, tasks and/or operations.' => 'Puede haber roles en lo más alto de la jerarquía de autorizaciones y otros roles pueden heredar a partir de otros roles, tareas y/o operaciones',
  'Source' => '',
  'En la jerarquía de autorización, las tareas estás por debajo de los roles y sólo pueden heredar otras tareas y/o operaciones.' => '',
  ...
  'Generate' => 'Generar',
  'Hover to see from where the permission is inherited.' => 'Pase el ratón para ver desde donde se hereda el permiso .',
  'Inherited' => 'Heredado',
