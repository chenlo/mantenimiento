...
/**
    ...
    public function getNombre(){
        $result = $this->profile->getAttribute("firstname")." ".$this->profile->getAttribute("lastname");
        return $result;
    }
    
    public function geUsuarioAsignableOptions()
    {
        ...
        $usersArray = CHtml::listData($rows, 'id', 'username');
        return $usersArray;
    }
